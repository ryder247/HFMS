                ...
                c => new
                    {
                        ...
                        PostalAddress = c.String(maxLength: 250),
                        Email = c.String(maxLength: 250),
                        Telephone = c.Long(nullable: false),
                        RelativeName = c.String(nullable: false, maxLength: 250),
                        RelativePhone = c.Long(nullable: false),
                        District = c.String(maxLength: 250),
                        SubDistrict = c.String(maxLength: 250),
                        HealthInsuranceScheme = c.String(maxLength: 250),
                        HealthInsuranceSchemeId = c.Long(nullable: false),
                        Gender_Id = c.Int(),
